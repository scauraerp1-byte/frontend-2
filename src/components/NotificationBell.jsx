    ...
    <>
      ...
      {open && (
        <>
          ...
          <div className="fixed z-50 right-3 sm:right-6 top-14 w-[92vw] sm:w-[380px] max-h-[70vh] flex flex-col glass-strong rounded-3xl border border-white/10 shadow-2xl fade-up" data-testid="notification-panel">
