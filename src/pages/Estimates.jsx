...
import { Plus, X, Search, Loader2, ScanLine, FileText, Download, Share2, Truck } from "lucide-react";
...
export function EstimateForm({ editMode = false }) {
  ...
  const filtered = products.filter(
    (p) => !picQ || p.title.toLowerCase().includes(picQ.toLowerCase()) || p.sr_number.toLowerCase().includes(picQ.toLowerCase())
  );
